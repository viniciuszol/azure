Esse bootcamp de Azure tá sendo bom demais. No começo eu não fazia ideia de quanta coisa existia por trás da nuvem, e agora já consigo entender bem como tudo se conecta.

Aprendi bastante sobre redes no Azure, como funcionam as VNets, sub-redes, peering, VPNs e o modelo hub and spoke, além de controlar tráfego com rotas e NSGs. Também entendi quando usar Load Balancer, Application Gateway, WAF e até Front Door, dependendo do tipo de aplicação e do tráfego.
